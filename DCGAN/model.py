...
class Discriminator (nn.Module):
    ...
    def block(self, features_in, features_out, kernel_size, stride, padding):
        return nn.Sequential(
            nn.Conv2d(features_in, features_out, kernel_size, stride, padding),
            nn.LeakyReLU(0.2),
        )
    def forward(self, x):
        return self.disc(x)
...
class Generator (nn.Module):
    ...
    def block(self, features_in, features_out, kernel_size, stride, padding):
        return nn.Sequential(
            nn.ConvTranspose2d(features_in, features_out, kernel_size, stride, padding),
